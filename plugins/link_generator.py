...
async def batch(client: Client, message: Message):
    ...
    while True:
        ...
        if s_msg_id:
            ...
            await second_message.reply(f"<b>❌ ᴇʀʀᴏʀ..\n<blockquote>ᴛʜɪs ғᴏʀᴡᴀʀᴅᴇᴅ ᴘᴏsᴛ ᴏʀ ᴍᴇssᴀɢᴇ ʟɪɴᴋ ɪs ɴᴏᴛ ғʀᴏᴍ ᴍʏ {channel}</blockquote></b>", quote=True, reply_markup=reply_markup, disable_web_page_preview=True)
            continue
